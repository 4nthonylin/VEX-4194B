...
#pragma config(Sensor, dgtl3,  youngPneumatics, sensorDigitalOut)
...
#pragma config(Motor,  port1,           leftLift1,     tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port2,           leftLift2,     tmotorVex393, openLoop)
...
#pragma config(Motor,  port10,          rightLift1,    tmotorVex393, openLoop)
...
task buttons(){
	...
	if(vexRT[Btn8R] == 1) SensorValue(youngPneumatics) = 1;
	if(vexRT[Btn8L] == 1) SensorValue(youngPneumatics) = 0;
